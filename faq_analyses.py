...
FAQ = [
    ...
    {"q": "Витамин D повышен что делать", "a": "Повышенный уровень витамина D (25-OH) чаще всего связан с избыточным приёмом препаратов витамина D. Возможна гиперкальциемия — опасное состояние. Нужно отменить или снизить дозу по назначению врача, контролировать кальций крови. Не отменяйте препараты самостоятельно — тактику определяет врач."},
    {"q": "Витамин D повышен причины", "a": "Причины повышенного витамина D: передозировка препаратов или добавок витамина D, реже — некоторые заболевания (гранулёматозы, лимфомы). Важно проверить кальций и паратгормон. Интерпретация у терапевта или эндокринолога."},
    ...
    {"q": "Витамин D норма в крови", "a": "Оптимальный уровень 25-OH витамина D обычно 30–60 нг/мл. Дефицит — ниже 20. Выше референса — возможна передозировка. Референсы уточняйте в лаборатории."},
    {"q": "Витамин D выше нормы", "a": "Витамин D выше нормы чаще из-за избыточного приёма препаратов. Риск гиперкальциемии. Нужна коррекция дозы и контроль кальция по назначению врача."},
