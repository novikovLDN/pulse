...
def _normalize(text: str, allow_short: bool = False) -> List[str]:
    ...
    words = text.split()
    stop = {"что", "это", "значит", "как", "почему", "какой", "какая", "какие", "причины", "причина", "у", "в", "на", "при", "по", "для", "из", "и", "или", "с", "без", "не", "нет", "да", "так", "же", "ли", "нужно", "надо", "можно", "делать", "означает", "быть", "есть", "анализ", "анализе", "анализов", "крови", "моче", "мочи"}
    out = []
    for w in words:
        if w in stop:
            continue
